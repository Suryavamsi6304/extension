...
class ChatPanel {
    ...
    static createOrShow(client, workspacePath) {
        ...
        const panel = vscode.window.createWebviewPanel("genai.chat", "GenAI Chat", column, {
            enableScripts: true,
    ...
    _chat(userMessage) {
        ...
        let fullResponse = "";
        this._client.chatStreamCallback(userMessage, this._workspacePath, this._history.slice(-10), (token) => {
            fullResponse += token;
