...
exports.GitInsightsPanel = void 0;
const vscode = __importStar(require("vscode"));
class GitInsightsPanel {
    constructor(panel) {
        this.disposables = [];
        this.panel = panel;
    ...
    static createOrShow() {
        ...
        const panel = vscode.window.createWebviewPanel("genai.git", "Git Insights", column, { enableScripts: false, retainContextWhenHidden: true });
...
exports.GitInsightsPanel = GitInsightsPanel;
...
//# sourceMappingURL=GitInsightsPanel.js.map